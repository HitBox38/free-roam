...
// ComponentProps<T> preserves each Leaflet component's distinct props below.
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- Generic constraint supports heterogeneous component props.
function createLazyComponent<T extends ComponentType<any>>(
    factory: () => Promise<{ default: T }>
) {
    const LazyComponent = lazy(factory)

    return function LazyLeafletComponent(props: ComponentProps<T>) {
